...
## MIPI A Port
set_property -dict { PACKAGE_PIN B8 IOSTANDARD LVCMOS12 } [get_ports { mipi_a_power }]; #IO_L22N_T3U_N7_DBC_AD0N_66 Sch=mipi_a_pwup_ls
...
## MUX I2C
set_property -dict { PACKAGE_PIN F6   IOSTANDARD LVCMOS12 DRIVE 6 } [get_ports { iic_mux_reset }]; 

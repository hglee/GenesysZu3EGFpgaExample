...
wire   [63:0] entry_proc_U0_HwReg_frm_buffer_c_din;
...
system_v_frmbuf_wr_0_0_fifo_w64_d4_S HwReg_frm_buffer_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_frmbuf_wr_0_0_fifo_w15_d3_S WidthInBytes_val2_c11_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_frmbuf_wr_0_0_fifo_w48_d2_S img_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_frmbuf_wr_0_0_fifo_w128_d480_B bytePlanes_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //system_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow

...
(* CORE_GENERATION_INFO="system_v_frmbuf_wr_0_0_v_frmbuf_wr,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sfvc784-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=24,HLS_SYN_DSP=0,HLS_SYN_FF=3492,HLS_SYN_LUT=4672,HLS_VERSION=2023_2}" *)
...
reg   [63:0] frm_buffer_read_reg_220;
reg   [15:0] stride_read_reg_225;
wire   [5:0] empty_fu_189_p1;
reg   [5:0] empty_reg_230;
wire   [11:0] empty_50_fu_193_p1;
reg   [11:0] empty_50_reg_235;
wire   [11:0] empty_51_fu_197_p1;
reg   [11:0] empty_51_reg_240;
wire  signed [14:0] empty_52_fu_201_p1;
reg  signed [14:0] empty_52_reg_245;
wire   [14:0] WidthInBytes_fu_215_p2;
reg   [14:0] WidthInBytes_reg_260;
wire    ap_CS_fsm_state2;
reg   [2:0] colorFormat_reg_265;
wire    grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWVALID;
wire   [63:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWADDR;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWLEN;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWSIZE;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWBURST;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWLOCK;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWCACHE;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWPROT;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWQOS;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWREGION;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WVALID;
wire   [127:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WDATA;
wire   [15:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WSTRB;
wire    grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WLAST;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WID;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARVALID;
wire   [63:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARADDR;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARLEN;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARSIZE;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARBURST;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARLOCK;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARCACHE;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARPROT;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARQOS;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARREGION;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_RREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_BREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_162_ap_start;
wire    grp_FrmbufWrHlsDataFlow_fu_162_s_axis_video_TREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_162_ap_done;
wire    grp_FrmbufWrHlsDataFlow_fu_162_ap_ready;
wire    grp_FrmbufWrHlsDataFlow_fu_162_ap_idle;
reg    grp_FrmbufWrHlsDataFlow_fu_162_ap_continue;
wire    flush;
...
reg    mm_video_BREADY;
reg    grp_FrmbufWrHlsDataFlow_fu_162_ap_start_reg;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state4;
wire    ap_sync_grp_FrmbufWrHlsDataFlow_fu_162_ap_ready;
wire    ap_sync_grp_FrmbufWrHlsDataFlow_fu_162_ap_done;
reg    ap_block_state4_on_subcall_done;
reg    ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_ready;
reg    ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_done;
wire   [63:0] zext_ln194_fu_205_p1;
...
wire   [14:0] WidthInBytes_fu_215_p10;
wire    ap_ce_reg;

// power-on initialization
initial begin
#0 ap_CS_fsm = 4'd1;
#0 grp_FrmbufWrHlsDataFlow_fu_162_ap_start_reg = 1'b0;
#0 ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_ready = 1'b0;
#0 ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_done = 1'b0;
end

system_v_frmbuf_wr_0_0_BYTES_PER_PIXEL_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 44 ),
    .AddressWidth( 6 ))
BYTES_PER_PIXEL_U(
...
system_v_frmbuf_wr_0_0_MEMORY2LIVE_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 44 ),
    .AddressWidth( 6 ))
MEMORY2LIVE_U(
...
system_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow grp_FrmbufWrHlsDataFlow_fu_162(
    ...
    .m_axi_mm_video_AWVALID(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWVALID),
    .m_axi_mm_video_AWREADY(mm_video_AWREADY),
    .m_axi_mm_video_AWADDR(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWADDR),
    .m_axi_mm_video_AWID(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWID),
    .m_axi_mm_video_AWLEN(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWLEN),
    .m_axi_mm_video_AWSIZE(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWSIZE),
    .m_axi_mm_video_AWBURST(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWBURST),
    .m_axi_mm_video_AWLOCK(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWLOCK),
    .m_axi_mm_video_AWCACHE(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWCACHE),
    .m_axi_mm_video_AWPROT(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWPROT),
    .m_axi_mm_video_AWQOS(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWQOS),
    .m_axi_mm_video_AWREGION(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWREGION),
    .m_axi_mm_video_AWUSER(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWUSER),
    .m_axi_mm_video_WVALID(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WVALID),
    .m_axi_mm_video_WREADY(mm_video_WREADY),
    .m_axi_mm_video_WDATA(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WDATA),
    .m_axi_mm_video_WSTRB(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WSTRB),
    .m_axi_mm_video_WLAST(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WLAST),
    .m_axi_mm_video_WID(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WID),
    .m_axi_mm_video_WUSER(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WUSER),
    .m_axi_mm_video_ARVALID(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARVALID),
    .m_axi_mm_video_ARREADY(1'b0),
    .m_axi_mm_video_ARADDR(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARADDR),
    .m_axi_mm_video_ARID(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARID),
    .m_axi_mm_video_ARLEN(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARLEN),
    .m_axi_mm_video_ARSIZE(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARSIZE),
    .m_axi_mm_video_ARBURST(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARBURST),
    .m_axi_mm_video_ARLOCK(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARLOCK),
    .m_axi_mm_video_ARCACHE(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARCACHE),
    .m_axi_mm_video_ARPROT(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARPROT),
    .m_axi_mm_video_ARQOS(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARQOS),
    .m_axi_mm_video_ARREGION(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARREGION),
    .m_axi_mm_video_ARUSER(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_ARUSER),
    .m_axi_mm_video_RVALID(1'b0),
    .m_axi_mm_video_RREADY(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_RREADY),
    ...
    .m_axi_mm_video_BREADY(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_BREADY),
    .m_axi_mm_video_BRESP(2'd0),
    .m_axi_mm_video_BID(1'd0),
    .m_axi_mm_video_BUSER(1'd0),
    .HwReg_frm_buffer(frm_buffer_read_reg_220),
    .WidthInBytes_val2(WidthInBytes_reg_260),
    .colorFormat_val3(colorFormat_reg_265),
    .width_val5(empty_51_reg_240),
    .height_val8(empty_50_reg_235),
    .stride_val9(stride_read_reg_225),
    .video_format_val10(empty_reg_230),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .HwReg_frm_buffer_ap_vld(1'b1),
    .WidthInBytes_val2_ap_vld(1'b1),
    .ap_start(grp_FrmbufWrHlsDataFlow_fu_162_ap_start),
    .s_axis_video_TVALID(s_axis_video_TVALID_int_regslice),
    .s_axis_video_TREADY(grp_FrmbufWrHlsDataFlow_fu_162_s_axis_video_TREADY),
    ...
    .ap_done(grp_FrmbufWrHlsDataFlow_fu_162_ap_done),
    .ap_ready(grp_FrmbufWrHlsDataFlow_fu_162_ap_ready),
    .ap_idle(grp_FrmbufWrHlsDataFlow_fu_162_ap_idle),
    .ap_continue(grp_FrmbufWrHlsDataFlow_fu_162_ap_continue)
);

system_v_frmbuf_wr_0_0_CTRL_s_axi #(
...
system_v_frmbuf_wr_0_0_mm_video_m_axi #(
    .CONSERVATIVE( 1 ),
    .USER_MAXREQS( 103 ),
...
mm_video_m_axi_U(
    ...
    .I_AWADDR(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWADDR),
    .I_AWLEN(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_AWLEN),
    .I_WVALID(mm_video_WVALID),
    .I_WREADY(mm_video_WREADY),
    .I_WDATA(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WDATA),
    .I_WSTRB(grp_FrmbufWrHlsDataFlow_fu_162_m_axi_mm_video_WSTRB),
    .I_BVALID(mm_video_BVALID),
    .I_BREADY(mm_video_BREADY)
);

system_v_frmbuf_wr_0_0_mul_15s_3ns_15_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 15 ),
    .din1_WIDTH( 3 ),
...
mul_15s_3ns_15_1_1_U125(
    .din0(empty_52_reg_245),
    .din1(WidthInBytes_fu_215_p1),
    .dout(WidthInBytes_fu_215_p2)
);

system_v_frmbuf_wr_0_0_regslice_both #(
    .DataWidth( 48 ))
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_done <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_done <= 1'b0;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_162_ap_done == 1'b1)) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_done <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_ready <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_ready <= 1'b0;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_162_ap_ready == 1'b1)) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_ready <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_FrmbufWrHlsDataFlow_fu_162_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state3) | ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_162_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state4)))) begin
            grp_FrmbufWrHlsDataFlow_fu_162_ap_start_reg <= 1'b1;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_162_ap_ready == 1'b1)) begin
            grp_FrmbufWrHlsDataFlow_fu_162_ap_start_reg <= 1'b0;
        end
    end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        WidthInBytes_reg_260 <= WidthInBytes_fu_215_p2;
        colorFormat_reg_265 <= MEMORY2LIVE_q0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        empty_50_reg_235 <= empty_50_fu_193_p1;
        empty_51_reg_240 <= empty_51_fu_197_p1;
        empty_52_reg_245 <= empty_52_fu_201_p1;
        empty_reg_230 <= empty_fu_189_p1;
        frm_buffer_read_reg_220 <= frm_buffer;
        stride_read_reg_225 <= stride;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
        grp_FrmbufWrHlsDataFlow_fu_162_ap_continue = 1'b1;
    end else begin
        grp_FrmbufWrHlsDataFlow_fu_162_ap_continue = 1'b0;
    end
end
...
assign BYTES_PER_PIXEL_address0 = zext_ln194_fu_205_p1;

assign MEMORY2LIVE_address0 = zext_ln194_fu_205_p1;

assign WidthInBytes_fu_215_p1 = WidthInBytes_fu_215_p10;

assign WidthInBytes_fu_215_p10 = BYTES_PER_PIXEL_q0;
...
always @ (*) begin
    ap_block_state4_on_subcall_done = ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_162_ap_ready & ap_sync_grp_FrmbufWrHlsDataFlow_fu_162_ap_done) == 1'b0);
end
...
assign ap_sync_grp_FrmbufWrHlsDataFlow_fu_162_ap_done = (grp_FrmbufWrHlsDataFlow_fu_162_ap_done | ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_done);

assign ap_sync_grp_FrmbufWrHlsDataFlow_fu_162_ap_ready = (grp_FrmbufWrHlsDataFlow_fu_162_ap_ready | ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_162_ap_ready);

assign empty_50_fu_193_p1 = height[11:0];

assign empty_51_fu_197_p1 = width[11:0];

assign empty_52_fu_201_p1 = width[14:0];

assign empty_fu_189_p1 = video_format[5:0];

assign grp_FrmbufWrHlsDataFlow_fu_162_ap_start = grp_FrmbufWrHlsDataFlow_fu_162_ap_start_reg;

assign s_axis_video_TREADY = regslice_both_s_axis_video_V_data_V_U_ack_in;

assign zext_ln194_fu_205_p1 = video_format;


reg find_df_deadlock = 0;
// synthesis translate_off
`include "system_v_frmbuf_wr_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "system_v_frmbuf_wr_0_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //system_v_frmbuf_wr_0_0_v_frmbuf_wr

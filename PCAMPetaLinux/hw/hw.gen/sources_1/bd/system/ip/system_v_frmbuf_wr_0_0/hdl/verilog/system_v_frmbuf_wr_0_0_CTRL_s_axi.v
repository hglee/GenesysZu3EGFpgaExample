...
// 0x58 : Data signal of frm_buffer3
//        bit 31~0 - frm_buffer3[63:32] (Read/Write)
// 0x5c : reserved
...
localparam
    ...
    ADDR_FRM_BUFFER3_DATA_1  = 7'h58,
    ADDR_FRM_BUFFER3_CTRL    = 7'h5c,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_FRM_BUFFER3_DATA_1: begin
                    rdata <= int_frm_buffer3[63:32];
                end
            endcase
        end
    end
...
// int_frm_buffer3[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        int_frm_buffer3[63:32] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_FRM_BUFFER3_DATA_1)
            int_frm_buffer3[63:32] <= (WDATA[31:0] & wmask) | (int_frm_buffer3[63:32] & ~wmask);
    end
end

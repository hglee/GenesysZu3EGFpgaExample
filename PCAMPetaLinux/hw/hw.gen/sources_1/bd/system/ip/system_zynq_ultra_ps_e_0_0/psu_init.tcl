...
set psu_pll_init_data {
    ...
    mask_write 0XFF5E0034 0xFE7FEDEF 0x7E578C62
		# : UPDATE FB_DIV
    ...
    mask_write 0XFF5E0030 0x00717F00 0x00013500
		# : BY PASS PLL
		# Register : RPLL_CTRL @ 0XFF5E0030</p>
    ...
    mask_write 0XFF5E0020 0x00717F00 0x00016400
		# : BY PASS PLL
		# Register : IOPLL_CTRL @ 0XFF5E0020</p>
    ...
    mask_write 0XFD1A0030 0xFE7FEDEF 0x7E4B0C82
		# : UPDATE FB_DIV
    ...
    mask_write 0XFD1A002C 0x00717F00 0x00015D00
		# : BY PASS PLL
		# Register : DPLL_CTRL @ 0XFD1A002C</p>
    ...
    mask_write 0XFD1A0038 0x00717F00 0x00016400
		# : BY PASS PLL
		# Register : VPLL_CTRL @ 0XFD1A0038</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01010402
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070064 0x0FFF83FF 0x00718079
    ...
    mask_write 0XFD0700DC 0xFFFFFFFF 0x05140301
    ...
    mask_write 0XFD070100 0x7F3F7F3F 0x0E0E1F10
    ...
    mask_write 0XFD070108 0x3F3F3F3F 0x0506060B
    ...
    mask_write 0XFD070110 0x1F0F0F1F 0x06030307
    ...
    mask_write 0XFD070120 0x7F7F7F7F 0x03030B05
    ...
    mask_write 0XFD07012C 0x7F1F031F 0x0E06010E
    ...
    mask_write 0XFD070184 0x3FFFFFFF 0x020162C4
    ...
    mask_write 0XFD070190 0x1FBFBF3F 0x04888207
    ...
    mask_write 0XFD0701B4 0x00003F3F 0x00000605
    ...
    mask_write 0XFD080018 0xFFFFFFFF 0x00F0DEC0
    ...
    mask_write 0XFD080040 0xFFFFFFFF 0x3A21D110
    ...
    mask_write 0XFD080044 0xFFFFFFFF 0xB5A41059
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x05200C07
    ...
    mask_write 0XFD080120 0xFFFFFFFF 0x00F22B06
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x002C0C07
    ...
    mask_write 0XFD080128 0xFFFFFFFF 0x00000A0C
    ...
    mask_write 0XFD080180 0xFFFFFFFF 0x00000414
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180030 0x000000FE 0x00000080
    ...
    mask_write 0XFF180038 0x000000FE 0x00000080
    ...
    mask_write 0XFF18003C 0x000000FE 0x00000080
    ...
    mask_write 0XFF180040 0x000000FE 0x00000080
    ...
    mask_write 0XFF180044 0x000000FE 0x00000080
    ...
    mask_write 0XFF180058 0x000000FE 0x00000040
    ...
    mask_write 0XFF18005C 0x000000FE 0x00000040
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B0203F
    ...
    mask_write 0XFF180138 0x03FFFFFF 0x033F3CFF
    ...
    mask_write 0XFF18013C 0x03FFFFFF 0x03FFFFC1
    ...
    mask_write 0XFF180148 0x03FFFFFF 0x023810FE
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x03FBFFA1
    ...
    mask_write 0XFF180144 0x023810FE 0x021810FE
    ...
    mask_write 0XFF180154 0x03FFFFFF 0x03FDDFFF
    ...
    mask_write 0XFF180158 0x03FFFFFF 0x03FFFFC0
    ...
    mask_write 0XFF180164 0x03FFFFFF 0x03F03F1C
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x0006303F
    ...
    mask_write 0XFF180160 0x03F1CFC0 0x03F1C000
    ...
    mask_write 0XFF180170 0x03FFFFFF 0x00FFFFFF
    ...
    mask_write 0XFF180178 0x03FFFFFF 0x00FBFFBF
    ...
    mask_write 0XFF180180 0x03FFFFFF 0x0104A04A
    ...
    mask_write 0XFF18017C 0x0104A04A 0x01040040
		# : LOOPBACK
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF260020 0xFFFFFFFF 0x01C9C380
    ...
    mask_write 0XFF0A0204 0x03FFFFFF 0x00000080
		# : DIR MODE BANK 1
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0208 0x03FFFFFF 0x00000080
    ...
    mask_write 0XFF0A0000 0xFFFFFFFF 0xFF7F0080
    ...
    mask_write 0XFF0A0000 0xFFFFFFFF 0xFF7F0000
		# : MASK_DATA_0_MSW LOW BANK [25:16]
		# : MASK_DATA_1_LSW LOW BANK [41:26]
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
...
mwr -force  0xFD080018 0x00F01AC5
...
mwr -force  0xFD080018 0x00F0FD6D

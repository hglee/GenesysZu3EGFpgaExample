...
(* CORE_GENERATION_INFO="bd_2d50_csc_0_v_csc,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sfvc784-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.604875,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=14,HLS_SYN_DSP=0,HLS_SYN_FF=6731,HLS_SYN_LUT=8910,HLS_VERSION=2023_2}" *)
...
wire   [11:0] Block_entry3_proc_U0_ap_return_20;
...
wire   [11:0] AXIvideo2MultiPixStream_U0_HwReg_width_c23_din;
...
wire   [11:0] v_vcresampler_core_1_U0_HwReg_width_c22_din;
...
wire   [11:0] v_hcresampler_core_2_U0_HwReg_width_c21_din;
...
wire   [11:0] v_csc_core_U0_HwReg_width_c20_din;
...
wire   [11:0] v_hcresampler_core_U0_HwReg_width_c19_din;
...
wire   [11:0] v_vcresampler_core_U0_HwReg_width_c_din;
...
wire   [2:0] HwReg_width_c24_channel_num_data_valid;
wire   [2:0] HwReg_width_c24_channel_fifo_cap;
wire    HwReg_width_c24_channel_empty_n;
wire   [11:0] HwReg_height_c30_channel_dout;
wire   [2:0] HwReg_height_c30_channel_num_data_valid;
wire   [2:0] HwReg_height_c30_channel_fifo_cap;
...
wire   [2:0] HwReg_width_c23_num_data_valid;
wire   [2:0] HwReg_width_c23_fifo_cap;
wire    HwReg_width_c23_empty_n;
wire    HwReg_height_c29_full_n;
wire   [11:0] HwReg_height_c29_dout;
wire   [2:0] HwReg_height_c29_num_data_valid;
wire   [2:0] HwReg_height_c29_fifo_cap;
...
wire   [2:0] HwReg_width_c22_num_data_valid;
wire   [2:0] HwReg_width_c22_fifo_cap;
wire    HwReg_width_c22_empty_n;
wire    HwReg_height_c28_full_n;
wire   [11:0] HwReg_height_c28_dout;
wire   [2:0] HwReg_height_c28_num_data_valid;
wire   [2:0] HwReg_height_c28_fifo_cap;
...
wire   [2:0] HwReg_width_c21_num_data_valid;
wire   [2:0] HwReg_width_c21_fifo_cap;
wire    HwReg_width_c21_empty_n;
wire    HwReg_height_c27_full_n;
wire   [11:0] HwReg_height_c27_dout;
wire   [2:0] HwReg_height_c27_num_data_valid;
wire   [2:0] HwReg_height_c27_fifo_cap;
...
wire   [2:0] HwReg_width_c20_num_data_valid;
wire   [2:0] HwReg_width_c20_fifo_cap;
wire    HwReg_width_c20_empty_n;
wire    HwReg_height_c26_full_n;
wire   [11:0] HwReg_height_c26_dout;
wire   [2:0] HwReg_height_c26_num_data_valid;
wire   [2:0] HwReg_height_c26_fifo_cap;
...
wire   [2:0] HwReg_width_c19_num_data_valid;
wire   [2:0] HwReg_width_c19_fifo_cap;
wire    HwReg_width_c19_empty_n;
wire    HwReg_height_c25_full_n;
wire   [11:0] HwReg_height_c25_dout;
wire   [2:0] HwReg_height_c25_num_data_valid;
wire   [2:0] HwReg_height_c25_fifo_cap;
...
bd_2d50_csc_0_fifo_w16_d5_S HwReg_K12_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w16_d5_S HwReg_K13_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w16_d5_S HwReg_K21_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w16_d5_S HwReg_K22_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w16_d5_S HwReg_K23_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w16_d5_S HwReg_K31_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w16_d5_S HwReg_K32_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w16_d5_S HwReg_K33_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w10_d5_S HwReg_ROffset_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w10_d5_S HwReg_GOffset_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w8_d5_S HwReg_ClipMax_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_width_c24_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_height_c30_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w48_d16_S stream_in_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_width_c23_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_height_c29_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w48_d16_S stream_in_vresampled_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_width_c22_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_height_c28_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w48_d16_S stream_in_hresampled_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_width_c21_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_height_c27_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_width_c20_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_height_c26_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w48_d16_S stream_out_hresampled_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_width_c19_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w48_d16_S stream_out_vresampled_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_width_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_2d50_csc_0_fifo_w12_d2_S HwReg_height_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
`include "bd_2d50_csc_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "bd_2d50_csc_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //bd_2d50_csc_0_v_csc

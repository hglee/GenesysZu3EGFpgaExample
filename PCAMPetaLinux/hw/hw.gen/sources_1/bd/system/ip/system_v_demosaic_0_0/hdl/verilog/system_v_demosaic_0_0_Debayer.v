...
module system_v_demosaic_0_0_Debayer (
        ap_start,
        start_full_n,
        start_out,
        start_write,
...
wire   [47:0] DebayerG_U0_imgG_din;
...
wire   [47:0] DebayerRatBorBatR_U0_imgRB_din;
...
wire   [47:0] DebayerRandBatG_U0_imgRgb_din;
...
wire   [2:0] bayerPhase_c9_num_data_valid;
wire   [2:0] bayerPhase_c9_fifo_cap;
wire    bayerPhase_c9_empty_n;
wire    imgRB_full_n;
wire   [47:0] imgRB_dout;
...
wire   [2:0] bayerPhase_c_fifo_cap;
...
system_v_demosaic_0_0_DebayerG DebayerG_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
system_v_demosaic_0_0_DebayerRatBorBatR DebayerRatBorBatR_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
system_v_demosaic_0_0_DebayerRandBatG DebayerRandBatG_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
system_v_demosaic_0_0_fifo_w48_d2_S imgG_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_fifo_w16_d2_S bayerPhase_c9_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_fifo_w48_d2_S imgRB_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_fifo_w16_d2_S bayerPhase_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_start_for_DebayerRatBorBatR_U0 start_for_DebayerRatBorBatR_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_start_for_DebayerRandBatG_U0 start_for_DebayerRandBatG_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //system_v_demosaic_0_0_Debayer

...
(* CORE_GENERATION_INFO="system_v_demosaic_0_0_v_demosaic,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sfvc784-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.231625,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=40,HLS_SYN_DSP=0,HLS_SYN_FF=8316,HLS_SYN_LUT=15804,HLS_VERSION=2023_2}" *)

module system_v_demosaic_0_0_v_demosaic (
        s_axi_CTRL_AWVALID,
        s_axi_CTRL_AWREADY,
        s_axi_CTRL_AWADDR,
        s_axi_CTRL_WVALID,
...
wire   [15:0] AXIvideo2MultiBayer_U0_imgBayer_din;
...
wire   [47:0] Debayer_U0_imgRgb_din;
...
wire   [47:0] ZipperRemoval_U0_imgUnzip_din;
...
wire   [2:0] bayer_phase_assign_channel_num_data_valid;
wire   [2:0] bayer_phase_assign_channel_fifo_cap;
wire    bayer_phase_assign_channel_empty_n;
wire    imgBayer_full_n;
wire   [15:0] imgBayer_dout;
...
system_v_demosaic_0_0_CTRL_s_axi #(
...
system_v_demosaic_0_0_Block_entry1_proc Block_entry1_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
system_v_demosaic_0_0_AXIvideo2MultiBayer AXIvideo2MultiBayer_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
system_v_demosaic_0_0_Debayer Debayer_U0(
...
system_v_demosaic_0_0_ZipperRemoval ZipperRemoval_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
system_v_demosaic_0_0_MultiPixStream2AXIvideo MultiPixStream2AXIvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
system_v_demosaic_0_0_fifo_w16_d2_S_x bayer_phase_assign_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_fifo_w16_d2_S_x imgBayer_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_fifo_w48_d2_S_x imgRgb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_fifo_w48_d2_S_x imgUnzip_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_start_for_ZipperRemoval_U0 start_for_ZipperRemoval_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_start_for_MultiPixStream2AXIvideo_U0 start_for_MultiPixStream2AXIvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
`include "system_v_demosaic_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "system_v_demosaic_0_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //system_v_demosaic_0_0_v_demosaic

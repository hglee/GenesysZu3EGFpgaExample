...
wire   [11:0] trunc_ln221_fu_130_p1;
reg   [11:0] trunc_ln221_reg_196;
reg    ap_block_state1;
wire   [10:0] div_i_i_fu_134_p4;
reg   [10:0] div_i_i_reg_201;
wire   [11:0] sub_i_i_fu_148_p2;
reg   [11:0] sub_i_i_reg_206;
...
wire   [47:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_106_m_axis_video_TDATA;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_106_m_axis_video_TVALID;
wire   [5:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_106_m_axis_video_TKEEP;
wire   [5:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_106_m_axis_video_TSTRB;
...
reg   [11:0] i_fu_78;
wire   [11:0] i_2_fu_173_p2;
wire   [11:0] div_i_i_cast_fu_144_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln228_1_fu_168_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_106_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign div_i_i_cast_fu_144_p1 = div_i_i_fu_134_p4;

assign div_i_i_fu_134_p4 = {{WidthOut[11:1]}};
...
assign grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_106_m_axis_video_TREADY = (m_axis_video_TREADY_int_regslice & ap_CS_fsm_state3);

assign i_2_fu_173_p2 = (i_fu_78 + 12'd1);

assign icmp_ln228_1_fu_168_p2 = ((i_fu_78 == trunc_ln221_reg_196) ? 1'b1 : 1'b0);

assign icmp_ln228_fu_154_p2 = ((div_i_i_fu_134_p4 == 11'd0) ? 1'b1 : 1'b0);
...
assign sub_i_i_fu_148_p2 = ($signed(div_i_i_cast_fu_144_p1) + $signed(12'd4095));

assign trunc_ln221_fu_130_p1 = Height[11:0];

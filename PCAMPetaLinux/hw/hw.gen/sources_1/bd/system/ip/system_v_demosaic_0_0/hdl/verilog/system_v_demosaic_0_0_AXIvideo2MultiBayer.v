...
wire   [11:0] trunc_ln145_fu_213_p1;
reg   [11:0] trunc_ln145_reg_346;
reg    ap_block_state1;
reg   [10:0] trunc_ln_reg_351;
wire    ap_CS_fsm_state2;
wire   [11:0] grp_reg_unsigned_short_s_fu_242_ap_return;
reg   [11:0] rows_reg_357;
wire    ap_CS_fsm_state4;
wire   [0:0] cmp10251_fu_250_p2;
reg   [0:0] cmp10251_reg_365;
wire   [0:0] xor_ln188_fu_255_p2;
reg   [0:0] xor_ln188_reg_370;
wire   [0:0] and_ln188_fu_279_p2;
reg   [0:0] and_ln188_reg_381;
wire    ap_CS_fsm_state5;
wire   [0:0] select_ln188_fu_297_p3;
reg   [0:0] select_ln188_reg_392;
...
wire   [15:0] grp_AXIvideo2MultiBayer_Pipeline_loop_wait_for_start_fu_142_axi_data_out;
...
wire   [15:0] grp_AXIvideo2MultiBayer_Pipeline_loop_width_fu_162_imgBayer_din;
...
wire   [15:0] grp_AXIvideo2MultiBayer_Pipeline_loop_width_fu_162_axi_data_3_out;
...
wire   [15:0] grp_AXIvideo2MultiBayer_Pipeline_loop_wait_for_eol_fu_190_axi_data_4_out;
...
wire   [11:0] grp_reg_unsigned_short_s_fu_221_d;
wire   [11:0] grp_reg_unsigned_short_s_fu_221_ap_return;
...
system_v_demosaic_0_0_AXIvideo2MultiBayer_Pipeline_loop_wait_for_eol grp_AXIvideo2MultiBayer_Pipeline_loop_wait_for_eol_fu_190(
    ...
    .select_ln188(select_ln188_reg_392),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln163_fu_264_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state9) & (grp_AXIvideo2MultiBayer_Pipeline_loop_wait_for_eol_fu_190_axi_data_4_out_ap_vld == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        and_ln188_reg_381 <= and_ln188_fu_279_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state9) & (grp_AXIvideo2MultiBayer_Pipeline_loop_wait_for_eol_fu_190_axi_last_4_out_ap_vld == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        cmp10251_reg_365 <= cmp10251_fu_250_p2;
        rows_reg_357 <= grp_reg_unsigned_short_s_fu_242_ap_return;
        xor_ln188_reg_370 <= xor_ln188_fu_255_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        select_ln188_reg_392 <= select_ln188_fu_297_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        trunc_ln145_reg_346 <= trunc_ln145_fu_213_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        trunc_ln_reg_351 <= {{grp_reg_unsigned_short_s_fu_221_ap_return[11:1]}};
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state6 : begin
            if (((1'b1 == ap_CS_fsm_state6) & (grp_AXIvideo2MultiBayer_Pipeline_loop_width_fu_162_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_state9 : begin
            if (((1'b1 == ap_CS_fsm_state9) & (grp_AXIvideo2MultiBayer_Pipeline_loop_wait_for_eol_fu_190_ap_done == 1'b1))) begin
...
assign and_ln188_fu_279_p2 = (xor_ln188_reg_370 & sof_reg_120);
...
assign cmp10251_fu_250_p2 = ((trunc_ln_reg_351 != 11'd0) ? 1'b1 : 1'b0);
...
assign grp_reg_unsigned_short_s_fu_221_d = WidthIn[11:0];

assign i_4_fu_269_p2 = (i_fu_88 + 12'd1);

assign icmp_ln163_fu_264_p2 = ((i_fu_88 == rows_reg_357) ? 1'b1 : 1'b0);
...
assign select_ln188_fu_297_p3 = ((cmp10251_reg_365[0:0] == 1'b1) ? grp_AXIvideo2MultiBayer_Pipeline_loop_width_fu_162_eol_out : axi_last_2_reg_132);

assign trunc_ln145_fu_213_p1 = Height[11:0];

assign xor_ln188_fu_255_p2 = (cmp10251_fu_250_p2 ^ 1'd1);

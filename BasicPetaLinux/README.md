...
I added a modified patch to read ethaddr from SPI in u-boot. For this, leave the `Subsystem AUTO Hardware Settings/Ethernet Settings/Ethernet MAC address` as blank. (`project-spec/meta-user/recipes-bsp/u-boot/files/0000-read-mac-spi.patch`)

### 3. Edit user device tree file

Edit `project-spec/meta-user/recipes-bsp/device-tree/files/system-user.dtsi` before building. The file below was taken from https://github.com/Digilent/Genesys-ZU and edited for 2023.2.
